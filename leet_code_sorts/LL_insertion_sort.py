...
class LinkedList:
    ...
    def insertion_sort(self):
        if self.length < 2:
            return
        # unsorted_from = self.head.next
        # while unsorted_from:
        #     sorted_until = self.head
        #     while unsorted_from.value < sorted_until.value:
        #         print('chamouu')
        #         temp = sorted_until.value
        #         sorted_until.value = unsorted_from.value
        #         unsorted_from.value = temp
        #         sorted_until = sorted_until.next
        #     unsorted_from = unsorted_from.next
